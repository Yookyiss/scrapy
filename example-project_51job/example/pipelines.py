...
class LaGouPipeline(object):
    ...
    def process_item(self,item,spider):
        ...
        cursor.execute(sql,(item["url"],item["job_name"],item["salary_low"],item["salary_top"],item["location"],item["work_years_low"],item["work_years_top"],item["education"],item["nature"],item["info_from"],item["date_time"],item["work_desc"],item["address"],item["company"],item["crawl_time"],item['lure']))
        self.connect.commit()
        print('ok')
